...
//  EastCity
//
//  Created by kongshuaishuai on 16/3/8.
...
class ERViewController: UIViewController , AVCaptureMetadataOutputObjectsDelegate{
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        timer = NSTimer(timeInterval: 0.02, target: self, selector: #selector(ERViewController.scanLineAnimation), userInfo: nil, repeats: true)
